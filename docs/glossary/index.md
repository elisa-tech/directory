...
| Safety element out of context | A safety-related element which is not developed in a particular context. |
| Safety standard | A standard that defines requirements and processes for ensuring functional safety, such as IEC 61508 or ISO 26262. |
