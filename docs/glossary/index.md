...
| Term | Explanation |
| :---- | :---- |
 Assumptions of Use (AoU) | Generally refers to conditions or assumptions about how a system will be used. These could include environmental factors, user interactions, and operational constraints. |
...
| Safety element out of context | A safety-related element which is not developed in a particular context, but with assumptions of use for the assumed context of operation. |
